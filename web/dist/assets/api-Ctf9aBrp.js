(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function e(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=e(a);fetch(a.href,o)}})();(function(){try{if(typeof window<"u"&&window.location.pathname.endsWith(".html")){let i=window.location.pathname.slice(0,-5);i==="/index"&&(i="/"),window.history.replaceState(null,"",(i||"/")+window.location.search+window.location.hash)}}catch{}})();const xt="/api";function X(){return localStorage.getItem("ci360_token")}function H(){try{return JSON.parse(localStorage.getItem("ci360_user"))}catch{return null}}function Bt(t,i){localStorage.setItem("ci360_token",t),localStorage.setItem("ci360_user",JSON.stringify(i))}function tt(){localStorage.removeItem("ci360_token"),localStorage.removeItem("ci360_user")}function $t(t){const i=X(),e=H();return!i||!e?(window.location.href="/login",null):t&&e.role!==t&&e.role!=="superadmin"?(window.location.href=e.role==="superadmin"?"/admin":e.role==="employee"?"/employee":"/client",null):e}async function T(t,i={}){const e=X(),n=Object.assign({"Content-Type":"application/json"},i.headers||{});e&&(n.Authorization="Bearer "+e);const a=await fetch(xt+t,Object.assign({},i,{headers:n}));if(a.status===401)throw tt(),window.location.href="/login",new Error("Session expired");let o=null;try{o=await a.json()}catch{}if(!a.ok)throw new Error(o&&o.error||"Server status "+a.status+" — Backend waking up, please retry in 10s.");return o}const et=t=>T(t,{method:"GET"}),F=(t,i)=>T(t,{method:"POST",body:JSON.stringify(i)}),q=(t,i)=>T(t,{method:"PUT",body:JSON.stringify(i)}),St=(t,i)=>T(t,{method:"PATCH",body:JSON.stringify(i)}),it=t=>T(t,{method:"DELETE"});function It(t){return t=Number(t)||0,"₹"+t.toLocaleString("en-IN",{maximumFractionDigits:0})}function Ct(t){return(Number(t)||0).toLocaleString("en-IN",{maximumFractionDigits:1})+" hrs"}function u(t){return t==null?"":String(t).replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i])}function V(t){return t?new Date(t).toISOString().slice(0,10):"—"}function $(){return localStorage.getItem("ci360_theme")||"light"}function D(t){localStorage.setItem("ci360_theme",t),document.documentElement.setAttribute("data-theme",t),document.querySelectorAll(".theme-btn").forEach(o=>{o.classList.toggle("active",o.dataset.theme===t)});const i=document.getElementById("tudThemeToggleBtn");if(i){const o=i.querySelector(".tud-icon"),s=i.querySelector(".tud-label");o&&(o.textContent=t==="dark"?"☀️":"🌙"),s&&(s.textContent=`Switch to ${t==="dark"?"Light":"Dark"} Mode`)}const e=document.getElementById("tudMobileThemeIcon"),n=document.getElementById("tudMobileThemeText");e&&(e.textContent=t==="dark"?"☀️":"🌙"),n&&(n.textContent=t==="dark"?"Light Mode":"Dark Mode");const a=document.getElementById("mmsToggleThemeBtn");if(a){const o=a.querySelector("span");o&&(o.textContent=t==="dark"?"☀️ Light Mode":"🌙 Dark Mode")}}function mt(){const t=$();document.documentElement.setAttribute("data-theme",t),document.querySelectorAll(".theme-btn").forEach(o=>{o.classList.toggle("active",o.dataset.theme===t)});const i=document.getElementById("tudThemeToggleBtn");if(i){const o=i.querySelector(".tud-icon"),s=i.querySelector(".tud-label");o&&(o.textContent=t==="dark"?"☀️":"🌙"),s&&(s.textContent=`Switch to ${t==="dark"?"Light":"Dark"} Mode`)}const e=document.getElementById("tudMobileThemeIcon"),n=document.getElementById("tudMobileThemeText");e&&(e.textContent=t==="dark"?"☀️":"🌙"),n&&(n.textContent=t==="dark"?"Light Mode":"Dark Mode");const a=document.getElementById("mmsToggleThemeBtn");if(a){const o=a.querySelector("span");o&&(o.textContent=t==="dark"?"☀️ Light Mode":"🌙 Dark Mode")}}try{mt()}catch{}function y(t,i){const e=document.createElement("div");e.className="toast",e.style.borderLeftColor=i?"var(--red-500)":"var(--green-500)",e.textContent=(i?"⚠️  ":"✓  ")+t,document.body.appendChild(e),setTimeout(()=>{e.style.opacity="0",e.style.transform="translateY(10px)",setTimeout(()=>e.remove(),200)},2800)}function ft(t){const i=document.createElement("div");return i.className="modal-bg",i.innerHTML=`<div class="modal">${t}</div>`,i.onclick=e=>{e.target===i&&i.remove()},document.body.appendChild(i),i}function j(){tt(),window.location.href="/login"}let z=null;async function nt(){if("serviceWorker"in navigator)try{z=await navigator.serviceWorker.register("/sw.js",{scope:"/"}),console.log("CI360 Service Worker active:",z.scope)}catch(t){console.warn("CI360 Service Worker registration notice:",t)}}try{nt()}catch{}let rt=0,ct=0;const N=new Set,dt=new Set;let pt=!1;function gt(t){try{const i=typeof H=="function"?H():null,e=i&&i._id?String(i._id):"default";return`${t}_${e}`}catch{return`${t}_default`}}function O(){try{const t=gt("ci360_alerted_ids"),i=localStorage.getItem(t);if(i){const e=JSON.parse(i);Array.isArray(e)&&e.forEach(n=>N.add(String(n)))}}catch{}}function G(){try{const t=gt("ci360_alerted_ids"),i=Array.from(N).slice(-2e3);localStorage.setItem(t,JSON.stringify(i))}catch{}}typeof window<"u"&&window.addEventListener("storage",t=>{t.key&&t.key.includes("ci360_alerted_ids")&&O()});function vt(){try{const t=Date.now();if(t-rt<5e3)return;rt=t;const i=window.AudioContext||window.webkitAudioContext;if(!i)return;const e=new i;e.state==="suspended"&&e.resume();const n=e.currentTime,a=e.createOscillator(),o=e.createGain();a.type="sine",a.frequency.setValueAtTime(587.33,n),o.gain.setValueAtTime(0,n),o.gain.linearRampToValueAtTime(.2,n+.02),o.gain.exponentialRampToValueAtTime(.001,n+.35),a.connect(o),o.connect(e.destination),a.start(n),a.stop(n+.35);const s=e.createOscillator(),l=e.createGain();s.type="sine",s.frequency.setValueAtTime(880,n+.12),l.gain.setValueAtTime(0,n+.12),l.gain.linearRampToValueAtTime(.22,n+.14),l.gain.exponentialRampToValueAtTime(.001,n+.55),s.connect(l),l.connect(e.destination),s.start(n+.12),s.stop(n+.55)}catch{}}function ht(){try{const t=Date.now();if(t-ct<5e3)return;ct=t,"vibrate"in navigator&&navigator.vibrate([150,80,150])}catch{}}function Mt(){try{if(typeof Notification<"u"&&Notification.permission==="granted"||localStorage.getItem("ci360_notif_enabled")==="true")return!0}catch{}return!1}function bt(){try{if(Mt()||localStorage.getItem("ci360_notif_banner_dismissed")==="true"||typeof Notification<"u"&&Notification.permission==="denied")return!0}catch{}return!1}async function Q(){if(!("Notification"in window))return y("Your browser does not support notifications.",!0),!1;try{const t=await Notification.requestPermission(),i=document.getElementById("notifPermissionBanner");return t==="granted"?(localStorage.setItem("ci360_notif_enabled","true"),i&&(i.classList.add("hidden"),i.style.setProperty("display","none","important"),i.remove()),y("Notifications enabled for this device!"),await R({title:"CI360 Notifications Active 🔔",message:"You will now receive instant alerts on this device for jobs and tasks.",id:"ci360-perm-welcome"}),!0):(i&&(i.classList.add("hidden"),i.style.setProperty("display","none","important")),y("Notification permission was declined.",!0),!1)}catch(t){console.error("Notification permission request error:",t)}return!1}async function R({title:t,message:i,type:e,id:n,url:a}){var l;const o=n?String(n):null;if(O(),o&&N.has(o)||(o&&(N.add(o),G()),vt(),ht(),!("Notification"in window)||Notification.permission!=="granted"))return;const s={body:i||"You have a new update in CI360.",icon:"/logo.png",badge:"/logo.png",tag:o?`ci360-notif-${o}`:"ci360-alert",renotify:!1,vibrate:[150,80,150],data:{url:a||window.location.href,type:e||"general"}};try{if(z&&z.showNotification){await z.showNotification(t,s);return}const m=await((l=navigator.serviceWorker)==null?void 0:l.ready);if(m&&m.showNotification){await m.showNotification(t,s);return}}catch(m){console.warn("Service Worker notification dispatch:",m)}try{const m=new Notification(t,s);m.onclick=()=>{window.focus(),m.close()}}catch(m){console.warn("Window Notification fallback notice:",m)}}function yt(){return`
    ...
    </div>`}function kt(){const t=document.getElementById("notifBellBtn"),i=document.getElementById("notifDropdown"),e=document.getElementById("notifBadge"),n=document.getElementById("notifList"),a=document.getElementById("clearNotifBtn"),o=document.getElementById("markAllReadBtn"),s=document.getElementById("testNotifBtn"),l=document.getElementById("notifEnableBtn"),m=document.getElementById("notifDismissBannerBtn"),v=document.getElementById("notifPermissionBanner"),x=document.getElementById("notifUnreadBadge");if(!t||!i)return;nt();function h(){const c=document.getElementById("notifPermissionBanner");c&&(c.classList.add("hidden"),c.style.setProperty("display","none","important"),c.remove())}function b(){if(bt()){h();return}"Notification"in window&&(Notification.permission==="granted"||Notification.permission==="denied"?h():Notification.permission==="default"&&v&&v.style.setProperty("display","flex","important"))}b(),m&&(m.onclick=c=>{c.stopPropagation(),localStorage.setItem("ci360_notif_banner_dismissed","true"),h()}),l&&(l.onclick=async c=>{c.stopPropagation(),localStorage.setItem("ci360_notif_enabled","true"),h(),await Q(),h()}),window.__ci360PollInterval&&(clearInterval(window.__ci360PollInterval),window.__ci360PollInterval=null),O();let k=[],f="all";function _(c){return c?c.startsWith("task_completed")?"🎉":c.startsWith("task_due")?"⚡":c.startsWith("task")?"✅":c.startsWith("target_completed")?"🎉":c.startsWith("target")?"🎯":c.startsWith("job_due")?"⏳":c.startsWith("job")?"📋":c.startsWith("ticket")?"🎫":c.startsWith("status")?"🔄":c.startsWith("test")?"🧪":"🔔":"🔔"}function E(c){if(!c)return"";const p=new Date(c),g=Math.floor((new Date-p)/1e3);if(g<60)return"Just now";const I=Math.floor(g/60);if(I<60)return`${I}m ago`;const W=Math.floor(I/60);if(W<24)return`${W}h ago`;const K=Math.floor(W/24);return K===1?"Yesterday":K<7?`${K}d ago`:V(c)}function S(){if(!n)return;let c=k;if(f==="task"?c=k.filter(p=>(p.type||"").includes("task")):f==="target"?c=k.filter(p=>(p.type||"").includes("target")):f==="job"?c=k.filter(p=>(p.type||"").includes("job")):f==="ticket"&&(c=k.filter(p=>(p.type||"").includes("ticket"))),c.length===0){n.innerHTML=`<div class="empty" style="padding:28px 16px;font-size:12.5px;color:var(--text-4)">No ${f==="all"?"":f+" "}notifications</div>`;return}n.innerHTML=c.map(p=>{const d=_(p.type);return`
        <div class="notif-item ${p.read?"":"unread"}" data-id="${p._id}" data-type="${u(p.type||"")}">
    ...
    <div class="app-shell">
      ...
      <aside class="app-sidebar" id="appSidebar">
        ...
        <div class="sidebar-user">
          ...
          <div class="user-details">
            <div class="name">${u(t?t.name:"User")}</div>
            <div class="role">${u(l)}</div>
          </div>
        </div>
      </aside>
      ...
      <main class="app-main" role="main">
          ...
          <div class="topbar-left">
            ...
            <div class="topbar-breadcrumb-wrap">
              <div class="topbar-breadcrumbs">
                ...
                <span class="topbar-crumb-portal">${u(l)}</span>
                <span class="topbar-crumb-sep">/</span>
                <span class="topbar-crumb-active">${u(b)}</span>
              </div>
              <div class="topbar-title-row">
                <h1 class="page-heading-title">${u(b)}</h1>
                ${o?`<span class="topbar-subtitle-pill" title="${u(o)}">${u(o)}</span>`:""}
              </div>
            </div>
          </div>
            ...
            <div class="topbar-user-menu-wrap">
              <button type="button" class="topbar-user-btn" id="topbarUserBtn" aria-expanded="false" aria-haspopup="true" title="Account & settings">
                ...
                <div class="topbar-user-meta">
                  <span class="topbar-user-name">${u(m)}</span>
                  <span class="topbar-user-role-badge">${u(l)}</span>
                </div>
              ...
              <div class="topbar-user-dropdown" id="topbarUserDropdown" style="display:none" role="menu">
                ...
                <div class="tud-desktop-only">
                  <div class="tud-header">
                    ...
                    <div class="tud-meta">
                      <div class="tud-name">${u(m)}</div>
                      ${v?`<div class="tud-email">${u(v)}</div>`:""}
                      <span class="tud-role-chip">${u(l)}</span>
                    </div>
                  </div>
        ...
        <nav class="mobile-bottom-nav" id="mobileBottomNav" aria-label="Mobile Navigation">
          ${k.map(f=>`
            <button type="button" class="mbn-item ${f.active?"active":""}" data-tab="${f.key}" ${f.isMore?'id="mobileMoreBtn"':""}>
              ...
              <span class="mbn-label">${u(f.label)}</span>
            ...
            <div class="mms-grid">
              ${n.map(f=>`
                <button type="button" class="mms-card ${e===f.key?"active":""}" data-tab="${f.key}">
                  ...
                  <span class="mms-card-label">${u(f.label)}</span>
                </button>
              `).join("")}
            </div>
    ...
    </div>`}function Tt(t){const i=document.getElementById("mobileNavToggle"),e=document.getElementById("appSidebar"),n=document.getElementById("sidebarOverlay");function a(){e&&e.classList.add("open"),n&&n.classList.add("open")}function o(){e&&e.classList.remove("open"),n&&n.classList.remove("open")}i&&(i.onclick=a),n&&(n.onclick=o);const s=document.getElementById("mobileMoreBackdrop"),l=document.getElementById("mobileMoreSheet"),m=document.getElementById("mmsCloseBtn"),v=document.getElementById("mobileMoreBtn");function x(){s&&s.classList.add("active"),l&&l.classList.add("active")}function h(){s&&s.classList.remove("active"),l&&l.classList.remove("active")}v&&(v.onclick=d=>{d.stopPropagation(),x()}),m&&(m.onclick=h),s&&(s.onclick=d=>{d.target===s&&h()}),document.querySelectorAll(".mbn-item").forEach(d=>{d.dataset.tab&&d.dataset.tab!=="__more__"&&(d.onclick=()=>{h(),t&&t(d.dataset.tab)})}),document.querySelectorAll(".mms-card").forEach(d=>{d.onclick=()=>{h(),t&&t(d.dataset.tab)}});const b=document.getElementById("mmsToggleThemeBtn");b&&(b.onclick=()=>{D($()==="dark"?"light":"dark")});const k=document.getElementById("mmsNotifsBtn");k&&(k.onclick=()=>{h();const d=document.getElementById("notifBellBtn");d&&d.click()});const f=document.getElementById("mmsLogoutBtn");f&&(f.onclick=j);const _=document.getElementById("mobileCalBtn");_&&(_.onclick=()=>{const d=document.querySelector(".period-row");d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),d.classList.add("pulse-highlight"),setTimeout(()=>d.classList.remove("pulse-highlight"),1200))});const E=document.getElementById("tudMobileThemeBtn");E&&(E.onclick=d=>{d.stopPropagation(),D($()==="dark"?"light":"dark")});const S=document.getElementById("tudMobileNotifsBtn");S&&(S.onclick=d=>{d.stopPropagation();const g=document.getElementById("topbarUserDropdown");g&&(g.style.display="none");const I=document.getElementById("notifBellBtn");I&&I.click()});const M=document.getElementById("tudMobileSettingsBtn");M&&(M.onclick=d=>{d.stopPropagation();const g=document.getElementById("topbarUserDropdown");g&&(g.style.display="none"),document.querySelector('[data-tab="manage"]')&&t?t("manage"):x()});const r=document.getElementById("tudMobileHelpBtn");r&&(r.onclick=d=>{d.stopPropagation();const g=document.getElementById("topbarUserDropdown");g&&(g.style.display="none"),document.querySelector('[data-tab="tickets"]')&&t?t("tickets"):ft(`
        ...
        `)});const w=document.getElementById("logoutBtnMobile");w&&(w.onclick=j);const B=document.getElementById("topbarUserBtn"),L=document.getElementById("topbarUserDropdown");B&&L&&(B.onclick=d=>{d.stopPropagation();const g=L.style.display!=="none";L.style.display=g?"none":"block",B.setAttribute("aria-expanded",String(!g)),typeof window.ci360CloseNotifications=="function"&&window.ci360CloseNotifications()},document.addEventListener("click",d=>{!L.contains(d.target)&&!B.contains(d.target)&&(L.style.display="none",B.setAttribute("aria-expanded","false"))}));const P=document.getElementById("tudThemeToggleBtn");P&&(P.onclick=()=>{D($()==="dark"?"light":"dark")});const c=document.getElementById("topbarQuickLogJobBtn");c&&(c.onclick=()=>{t&&t("logjob")});const p=document.getElementById("logoutBtn");p&&(p.onclick=j),kt(),document.querySelectorAll(".sidebar-item").forEach(d=>{d.onclick=()=>{o(),t&&t(d.dataset.tab)}}),_t(t)}function _t(t){const i=document.getElementById("cmdPaletteBackdrop"),e=document.getElementById("cmdSearchInput"),n=document.getElementById("cmdResultsList"),a=document.getElementById("topbarCmdTrigger"),o=document.getElementById("topbarCmdTriggerMobile"),s=document.getElementById("tudCmdBtn"),l=document.getElementById("cmdCloseKbd");if(!i||!e||!n)return;const m=Array.from(document.querySelectorAll(".sidebar-item")),v=m.map(r=>{var w,B;return{type:"tab",id:r.dataset.tab,label:((w=r.querySelector("span:last-child"))==null?void 0:w.textContent)||r.dataset.tab,icon:((B=r.querySelector(".icon"))==null?void 0:B.textContent)||"📌",sub:"Navigate to section",action:()=>{t&&t(r.dataset.tab)}}});m.some(r=>r.dataset.tab==="logjob")&&v.unshift({type:"action",id:"quick-logjob",label:"Log a New Job",icon:"➕",sub:"Create & submit work delivery",action:()=>{t&&t("logjob")}}),v.push({type:"action",id:"toggle-theme",label:$()==="dark"?"Switch to Light Mode":"Switch to Dark Mode",icon:"🌓",sub:"Change interface appearance",action:()=>{D($()==="dark"?"light":"dark")}}),v.push({type:"action",id:"notifs",label:"View Notifications",icon:"🔔",sub:"Pending alerts and notices",action:()=>{const r=document.getElementById("notifBellBtn");r&&r.click()}}),v.push({type:"action",id:"logout",label:"Sign out of CI360",icon:"🚪",sub:"End current authenticated session",action:()=>j()});let h=0,b=[...v];function k(){if(!b.length){n.innerHTML='<div class="cmd-result" style="color:var(--text-4);cursor:default;justify-content:center;padding:24px 14px;">No matching tabs or commands found</div>';return}n.innerHTML=b.map((r,w)=>`
      <div class="cmd-result ${w===h?"selected":""}" data-idx="${w}">
        <div class="cmd-result-icon">${r.icon}</div>
        <div style="flex:1;min-width:0">
          <div style="font-weight:700;line-height:1.2">${u(r.label)}</div>
          <div style="font-size:11px;color:var(--text-4);font-weight:500">${u(r.sub)}</div>
        </div>
        <kbd class="cmd-kbd" style="font-size:9.5px">↵</kbd>
      </div>
    `).join(""),n.querySelectorAll(".cmd-result").forEach(r=>{r.onmouseenter=()=>{h=Number(r.dataset.idx),f()},r.onclick=()=>{_(Number(r.dataset.idx))}})}function f(){n.querySelectorAll(".cmd-result").forEach((r,w)=>{r.classList.toggle("selected",w===h)})}function _(r){const w=b[r];w&&w.action&&(S(),w.action())}function E(){const r=document.getElementById("topbarUserDropdown");r&&(r.style.display="none"),i.classList.add("open"),e.value="",b=[...v],h=0,k(),setTimeout(()=>e.focus(),50)}function S(){i.classList.remove("open"),e.blur()}a&&(a.onclick=E),o&&(o.onclick=E),s&&(s.onclick=()=>{const r=document.getElementById("topbarUserDropdown");r&&(r.style.display="none"),E()}),l&&(l.onclick=S),i.onclick=r=>{r.target===i&&S()},e.oninput=()=>{const r=e.value.trim().toLowerCase();r?b=v.filter(w=>w.label.toLowerCase().includes(r)||w.sub.toLowerCase().includes(r)):b=[...v],h=0,k()},e.onkeydown=r=>{if(r.key==="ArrowDown"){if(r.preventDefault(),b.length>0){h=(h+1)%b.length,f();const w=n.querySelector(".cmd-result.selected");w&&w.scrollIntoView({block:"nearest"})}}else if(r.key==="ArrowUp"){if(r.preventDefault(),b.length>0){h=(h-1+b.length)%b.length,f();const w=n.querySelector(".cmd-result.selected");w&&w.scrollIntoView({block:"nearest"})}}else r.key==="Enter"?(r.preventDefault(),_(h)):r.key==="Escape"&&(r.preventDefault(),S())};const M=r=>{(r.metaKey||r.ctrlKey)&&r.key.toLowerCase()==="k"?(r.preventDefault(),i.classList.contains("open")?S():E()):r.key==="Escape"&&i.classList.contains("open")&&S()};window.__ci360CmdKeyHandler&&window.removeEventListener("keydown",window.__ci360CmdKeyHandler),window.__ci360CmdKeyHandler=M,window.addEventListener("keydown",M)}function Lt(t=4){return`
  ...
  `,s.onclick=l=>{(l.target===s||l.target.closest(".preview-modal-close"))&&s.remove()},document.body.appendChild(s)}function Y(t=[],i={}){if(!t||!t.length)return"";const e=!!i.canDelete;return`
    <div class="attachment-chips-wrap">
      ${i.title?`<div class="attachment-chips-header">📎 ${u(i.title)} <span style="font-weight:500;color:var(--text-4)">(${t.length})</span></div>`:""}
      <div class="attachment-chips-list">
        ${t.map((n,a)=>{const o=U(n.name,n.type),s=u(n.name||"File"),l=J(n.size);return`
  ...
  `}const C={};async function Z(t){const i=Array.from(t||[]);if(!i.length)return[];const n=(await Promise.all(i.map(async a=>new Promise(o=>{const s=new FileReader;s.onload=()=>{o({name:a.name,type:a.type,size:a.size,base64:s.result,data:s.result})},s.onerror=()=>o(null),s.readAsDataURL(a)})))).filter(Boolean);if(!n.length)return[];try{const a=await F("/upload",{files:n});if(a&&a.files&&a.files.length)return a.files}catch(a){console.warn("Backend upload failed, fallback to base64 data URLs:",a)}return n.map(a=>({name:a.name,url:a.base64,size:a.size,type:a.type,uploadedAt:new Date}))}function st({id:t="uploader",label:i="Attachments & Files",subtitle:e="Upload briefs, proofs, PDFs, spreadsheets, screenshots or design assets",multiple:n=!0,accept:a="*/*",maxFiles:o=10}={}){return`
    <div class="uploader-container" id="container-${t}">
      ...
      <div class="uploader-zone" id="zone-${t}">
        ...
        <div class="uploader-subtitle">${u(e)}</div>
  ...
  `}function at(t,i={}){const e=document.getElementById("zone-"+t),n=document.getElementById("input-"+t),a=document.getElementById("list-"+t),o=document.getElementById("count-"+t);C[t]=i.existing?[...i.existing]:[];function s(){const l=C[t]||[];if(o&&(o.textContent=`${l.length} file${l.length===1?"":"s"} attached`),!!a){if(!l.length){a.innerHTML="";return}a.innerHTML=l.map((m,v)=>{const x=U(m.name,m.type),h=u(m.name||"File"),b=J(m.size);return`
      ...
      `}).join(""),i.onChange&&i.onChange(l)}}window.__removeUploaderFile=(l,m)=>{if(C[l]){C[l].splice(m,1);const v=window[`__update_${l}`];v&&v()}},window.__previewUploaderFile=(l,m)=>{const v=(C[l]||[])[m];v&&ot(v)},window[`__update_${t}`]=s,e&&n&&(e.onclick=l=>{l.target.tagName!=="BUTTON"&&!l.target.closest("button")&&n.click()},e.ondragover=l=>{l.preventDefault(),e.classList.add("dragover")},e.ondragleave=()=>e.classList.remove("dragover"),e.ondrop=async l=>{if(l.preventDefault(),e.classList.remove("dragover"),l.dataTransfer&&l.dataTransfer.files&&l.dataTransfer.files.length){y("Uploading files… ⏳");const m=await Z(l.dataTransfer.files);C[t]=[...C[t]||[],...m],s(),y("Files attached! ✓")}},n.onchange=async()=>{if(n.files&&n.files.length){y("Uploading files… ⏳");const l=await Z(n.files);C[t]=[...C[t]||[],...l],s(),y("Files attached! ✓"),n.value=""}}),s()}function lt(t){return C[t]||[]}function wt(t,i=[]){C[t]=[...i];const e=window[`__update_${t}`];e&&e()}window.__openPreview=(t,i)=>{const e=i.closest(".attachment-chips-wrap");if(!e)return;const n=i.closest(".attachment-chip");if(!n)return;const a=Number(n.dataset.idx),o=e.dataset.attachments;if(o)try{const s=JSON.parse(decodeURIComponent(o));s[a]&&ot(s[a])}catch{}};function Ut(t,i=!1){const e=t.replace(/[^a-z0-9]/gi,"");return`
      ...
      <div class="ticket-card-header">
        <div>
          <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px">
            ...
            <span class="ticket-subject">${u(t.subject)}</span>
          </div>
        </div>
        <div class="ticket-meta-badges">
          <span class="badge ${qt[t.status]||"gray"}">
            ${n?'<span class="pulse-dot"></span>':""} ${u(t.status)}
          </span>
          <span class="badge ${Ht[t.priority]||"gray"}">${u(t.priority)}</span>
        </div>
      </div>
      ...
      <div class="ticket-author-row">
        ...
        <div class="ticket-author-meta">
          <div class="ticket-author-name">
            ${u(t.userName)}
            <span class="ticket-role-pill">${u(t.userRole)}</span>
          </div>
          <span class="ticket-time-ago">${ut(t.createdAt)} · ${V(t.createdAt)}</span>
        </div>
      </div>

      <div class="ticket-message-box">${u(t.message)}</div>
        ...
        <div class="ticket-thread-wrap">
          <div class="ticket-admin-reply-card">
            <div class="ticket-admin-reply-header">
              ...
              ${t.repliedAt?`<span style="font-size:11px;color:var(--text-4)">${ut(t.repliedAt)}</span>`:""}
            </div>
            <div class="ticket-admin-reply-text">${u(t.adminReply)}</div>
      ...
      ${i?`
        <div class="ticket-toolbar">
          ...
          <div class="ticket-reply-form" id="tkreplyform-${t._id}">
            ...
            <textarea id="tkreplytxt-${t._id}" rows="2" placeholder="Write response to ticket..." style="font-size:13px;padding:8px 10px;border:1px solid var(--border-sm);border-radius:var(--r-sm);background:var(--bg-surface);color:var(--text-1);resize:vertical;width:100%;box-sizing:border-box">${u(t.adminReply||"")}</textarea>
    ...
    </div>`}async function A(t,i,e){const n=document.getElementById("tklist-"+i),a=document.getElementById("tkcnt-"+i);if(n)try{const o=await et("/tickets/job/"+t);a&&(a.textContent=o.length),o.length?(n.innerHTML=o.map(s=>Ot(s,e)).join(""),Ft(t,i,e,n,o)):n.innerHTML='<div style="font-size:12px;color:var(--text-4);padding:8px 0;font-style:italic">No tickets on this job yet.</div>'}catch{n.innerHTML='<div style="font-size:12px;color:var(--s-red-text)">Could not load tickets.</div>'}}function Ft(t,i,e,n,a){e&&(n.querySelectorAll(".tk-status-sel").forEach(o=>{o.onchange=async()=>{try{await q("/tickets/"+o.dataset.tkid,{status:o.value}),y("Status updated"),A(t,i,e)}catch(s){y(s.message,!0)}}}),n.querySelectorAll(".tk-quick-resolve-btn").forEach(o=>{o.onclick=async()=>{try{await q("/tickets/"+o.dataset.tkid,{status:"Resolved"}),y("Ticket marked as Resolved! 🎉"),A(t,i,e)}catch(s){y(s.message,!0)}}}),n.querySelectorAll(".ticket-template-btn").forEach(o=>{o.onclick=()=>{const s=document.getElementById("tkreplytxt-"+o.dataset.tkid);s&&(s.value=o.dataset.tpl,s.focus())}}),n.querySelectorAll(".tk-reply-toggle").forEach(o=>{o.onclick=()=>{const s=o.dataset.tkid,l=document.getElementById("tkreplyform-"+s);if(l){l.classList.toggle("show");const m=a.find(v=>v._id===s);at("tkreplyup-"+s,{existing:m?m.adminAttachments:[]})}}}),n.querySelectorAll(".tk-reply-cancel").forEach(o=>{o.onclick=()=>{const s=document.getElementById("tkreplyform-"+o.dataset.tkid);s&&s.classList.remove("show")}}),n.querySelectorAll(".tk-reply-save").forEach(o=>{o.onclick=async()=>{const s=o.dataset.tkid,l=document.getElementById("tkreplytxt-"+s);if(!l)return;const m=lt("tkreplyup-"+s);try{await q("/tickets/"+s,{adminReply:l.value.trim(),adminAttachments:m}),y("Response saved! 🛡️"),A(t,i,e)}catch(v){y(v.message,!0)}}}),n.querySelectorAll(".tk-del-btn").forEach(o=>{o.onclick=async()=>{if(confirm("Permanently delete this ticket?"))try{await it("/tickets/"+o.dataset.tkid),y("Ticket deleted"),A(t,i,e)}catch(s){y(s.message,!0)}}}))}function Vt(t,i=!1){const e=t.replace(/[^a-z0-9]/gi,"");A(t,e,i),at("tkup-"+e);const n=document.querySelector(`[data-jobid="${t}"].ticket-toggle-btn`);n&&(n.onclick=()=>{const s=document.getElementById("tkform-"+e);if(!s)return;const l=s.style.display==="block";s.style.display=l?"none":"block",n.textContent=l?"+ Raise Ticket":"✕ Cancel"});const a=document.querySelector(`.tk-cancel-btn[data-safeid="${e}"]`);a&&(a.onclick=()=>{const s=document.getElementById("tkform-"+e);s&&(s.style.display="none"),n&&(n.textContent="+ Raise Ticket")});const o=document.querySelector(`.tk-submit-btn[data-safeid="${e}"]`);o&&(o.onclick=async()=>{var x,h;const s=(x=(document.getElementById("tksub-"+e)||{}).value)==null?void 0:x.trim(),l=(h=(document.getElementById("tkmsg-"+e)||{}).value)==null?void 0:h.trim(),m=(document.getElementById("tkpri-"+e)||{}).value,v=lt("tkup-"+e);if(!s){y("Please enter a subject",!0);return}if(!l){y("Please enter a message",!0);return}o.disabled=!0,o.textContent="Submitting…";try{await F("/tickets",{jobId:t,subject:s,message:l,priority:m,attachments:v}),y("Ticket submitted! 🎫");const b=document.getElementById("tkform-"+e);b&&(b.style.display="none"),n&&(n.textContent="+ Raise Ticket");const k=document.getElementById("tksub-"+e),f=document.getElementById("tkmsg-"+e);k&&(k.value=""),f&&(f.value=""),wt("tkup-"+e,[]),A(t,e,i)}catch(b){y(b.message,!0)}finally{o.disabled=!1,o.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M22 2L11 13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> Submit Ticket'}})}function Jt(){return""}function Wt(){}window.__setTheme=function(t){D(t)};Object.assign(window,{getToken:X,getUser:H,setSession:Bt,clearSession:tt,requireAuth:$t,initTheme:mt,api:T,apiGet:et,apiPost:F,apiPut:q,apiPatch:St,apiDelete:it,fmtINR:It,fmtHours:Ct,escapeHtml:u,fmtDate:V,flashToast:y,openModal:ft,logout:j,getTheme:$,setTheme:D,initServiceWorker:nt,playNotificationChime:vt,triggerPhoneVibration:ht,requestNotificationPermission:Q,triggerSystemNotification:R,fmtFileSize:J,getFileCategory:U,isImageAttachment:Rt,openFilePreviewModal:ot,renderAttachmentChips:Y,uploadFilesToServer:Z,renderAttachmentUploader:st,bindAttachmentUploader:at,getUploaderAttachments:lt,setUploaderAttachments:wt,renderRoleSwitcher:Jt,bindRoleSwitcher:Wt,renderNotificationBell:yt,initNotificationBell:kt,renderAppShell:Et,bindAppShellEvents:Tt,renderSkeletonCards:Lt,renderEmptyState:Nt,renderKpiCard:At,renderBadge:Dt,renderProgressBar:Pt,renderPeriodPicker:jt,renderSupportTicketSection:Ut,bindSupportTicketSection:Vt});export{X as a,F as b,H as g,Bt as s};
