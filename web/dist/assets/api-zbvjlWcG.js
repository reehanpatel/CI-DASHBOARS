(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function e(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=e(a);fetch(a.href,o)}})();(function(){try{if(typeof window<"u"&&window.location.pathname.endsWith(".html")){let i=window.location.pathname.slice(0,-5);i==="/index"&&(i="/"),window.history.replaceState(null,"",(i||"/")+window.location.search+window.location.hash)}}catch{}})();const xt="/api";function X(){return localStorage.getItem("ci360_token")}function F(){try{return JSON.parse(localStorage.getItem("ci360_user"))}catch{return null}}function Bt(t,i){localStorage.setItem("ci360_token",t),localStorage.setItem("ci360_user",JSON.stringify(i))}function tt(){localStorage.removeItem("ci360_token"),localStorage.removeItem("ci360_user")}function $t(t){const i=X(),e=F();return!i||!e?(window.location.href="/login",null):t&&e.role!==t&&e.role!=="superadmin"?(window.location.href=e.role==="superadmin"?"/admin":e.role==="employee"?"/employee":"/client",null):e}async function T(t,i={}){const e=X(),n=Object.assign({"Content-Type":"application/json"},i.headers||{});e&&(n.Authorization="Bearer "+e);const a=await fetch(xt+t,Object.assign({},i,{headers:n}));if(a.status===401)throw tt(),window.location.href="/login",new Error("Session expired");let o=null;try{o=await a.json()}catch{}if(!a.ok)throw new Error(o&&o.error||"Server status "+a.status+" — Backend waking up, please retry in 10s.");return o}const et=t=>T(t,{method:"GET"}),J=(t,i)=>T(t,{method:"POST",body:JSON.stringify(i)}),O=(t,i)=>T(t,{method:"PUT",body:JSON.stringify(i)}),St=(t,i)=>T(t,{method:"PATCH",body:JSON.stringify(i)}),it=t=>T(t,{method:"DELETE"});function It(t){return t=Number(t)||0,"₹"+t.toLocaleString("en-IN",{maximumFractionDigits:0})}function Ct(t){return(Number(t)||0).toLocaleString("en-IN",{maximumFractionDigits:1})+" hrs"}function p(t){return t==null?"":String(t).replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i])}function W(t){return t?new Date(t).toISOString().slice(0,10):"—"}function $(){return localStorage.getItem("ci360_theme")||"light"}function P(t){localStorage.setItem("ci360_theme",t),document.documentElement.setAttribute("data-theme",t),document.querySelectorAll(".theme-btn").forEach(o=>{o.classList.toggle("active",o.dataset.theme===t)});const i=document.getElementById("tudThemeToggleBtn");if(i){const o=i.querySelector(".tud-icon"),s=i.querySelector(".tud-label");o&&(o.textContent=t==="dark"?"☀️":"🌙"),s&&(s.textContent=`Switch to ${t==="dark"?"Light":"Dark"} Mode`)}const e=document.getElementById("tudMobileThemeIcon"),n=document.getElementById("tudMobileThemeText");e&&(e.textContent=t==="dark"?"☀️":"🌙"),n&&(n.textContent=t==="dark"?"Light Mode":"Dark Mode");const a=document.getElementById("mmsToggleThemeBtn");if(a){const o=a.querySelector("span");o&&(o.textContent=t==="dark"?"☀️ Light Mode":"🌙 Dark Mode")}}function mt(){const t=$();document.documentElement.setAttribute("data-theme",t),document.querySelectorAll(".theme-btn").forEach(o=>{o.classList.toggle("active",o.dataset.theme===t)});const i=document.getElementById("tudThemeToggleBtn");if(i){const o=i.querySelector(".tud-icon"),s=i.querySelector(".tud-label");o&&(o.textContent=t==="dark"?"☀️":"🌙"),s&&(s.textContent=`Switch to ${t==="dark"?"Light":"Dark"} Mode`)}const e=document.getElementById("tudMobileThemeIcon"),n=document.getElementById("tudMobileThemeText");e&&(e.textContent=t==="dark"?"☀️":"🌙"),n&&(n.textContent=t==="dark"?"Light Mode":"Dark Mode");const a=document.getElementById("mmsToggleThemeBtn");if(a){const o=a.querySelector("span");o&&(o.textContent=t==="dark"?"☀️ Light Mode":"🌙 Dark Mode")}}try{mt()}catch{}function y(t,i){const e=document.createElement("div");e.className="toast",e.style.borderLeftColor=i?"var(--red-500)":"var(--green-500)",e.textContent=(i?"⚠️  ":"✓  ")+t,document.body.appendChild(e),setTimeout(()=>{e.style.opacity="0",e.style.transform="translateY(10px)",setTimeout(()=>e.remove(),200)},2800)}function ft(t){const i=document.createElement("div");return i.className="modal-bg",i.innerHTML=`<div class="modal">${t}</div>`,i.onclick=e=>{e.target===i&&i.remove()},document.body.appendChild(i),i}function R(){tt(),window.location.href="/login"}let U=null;async function nt(){if("serviceWorker"in navigator)try{U=await navigator.serviceWorker.register("/sw.js",{scope:"/"}),console.log("CI360 Service Worker active:",U.scope)}catch(t){console.warn("CI360 Service Worker registration notice:",t)}}try{nt()}catch{}let rt=0,ct=0;const N=new Set,dt=new Set;let ut=!1;function gt(t){try{const i=typeof F=="function"?F():null,e=i&&i._id?String(i._id):"default";return`${t}_${e}`}catch{return`${t}_default`}}function V(){try{const t=gt("ci360_alerted_ids"),i=localStorage.getItem(t);if(i){const e=JSON.parse(i);Array.isArray(e)&&e.forEach(n=>N.add(String(n)))}}catch{}}function G(){try{const t=gt("ci360_alerted_ids"),i=Array.from(N).slice(-2e3);localStorage.setItem(t,JSON.stringify(i))}catch{}}typeof window<"u"&&window.addEventListener("storage",t=>{t.key&&t.key.includes("ci360_alerted_ids")&&V()});function vt(){try{const t=Date.now();if(t-rt<5e3)return;rt=t;const i=window.AudioContext||window.webkitAudioContext;if(!i)return;const e=new i;e.state==="suspended"&&e.resume();const n=e.currentTime,a=e.createOscillator(),o=e.createGain();a.type="sine",a.frequency.setValueAtTime(587.33,n),o.gain.setValueAtTime(0,n),o.gain.linearRampToValueAtTime(.2,n+.02),o.gain.exponentialRampToValueAtTime(.001,n+.35),a.connect(o),o.connect(e.destination),a.start(n),a.stop(n+.35);const s=e.createOscillator(),l=e.createGain();s.type="sine",s.frequency.setValueAtTime(880,n+.12),l.gain.setValueAtTime(0,n+.12),l.gain.linearRampToValueAtTime(.22,n+.14),l.gain.exponentialRampToValueAtTime(.001,n+.55),s.connect(l),l.connect(e.destination),s.start(n+.12),s.stop(n+.55)}catch{}}function ht(){try{const t=Date.now();if(t-ct<5e3)return;ct=t,"vibrate"in navigator&&navigator.vibrate([150,80,150])}catch{}}function Mt(){try{if(typeof Notification<"u"&&Notification.permission==="granted"||localStorage.getItem("ci360_notif_enabled")==="true")return!0}catch{}return!1}function bt(){try{if(Mt()||localStorage.getItem("ci360_notif_banner_dismissed")==="true"||typeof Notification<"u"&&Notification.permission==="denied")return!0}catch{}return!1}async function Q(){if(!("Notification"in window))return y("Your browser does not support notifications.",!0),!1;try{const t=await Notification.requestPermission(),i=document.getElementById("notifPermissionBanner");return t==="granted"?(localStorage.setItem("ci360_notif_enabled","true"),i&&(i.classList.add("hidden"),i.style.setProperty("display","none","important"),i.remove()),y("Notifications enabled for this device!"),await q({title:"CI360 Notifications Active 🔔",message:"You will now receive instant alerts on this device for jobs and tasks.",id:"ci360-perm-welcome"}),!0):(i&&(i.classList.add("hidden"),i.style.setProperty("display","none","important")),y("Notification permission was declined.",!0),!1)}catch(t){console.error("Notification permission request error:",t)}return!1}async function q({title:t,message:i,type:e,id:n,url:a}){var l;const o=n?String(n):null;if(V(),o&&N.has(o)||(o&&(N.add(o),G()),vt(),ht(),!("Notification"in window)||Notification.permission!=="granted"))return;const s={body:i||"You have a new update in CI360.",icon:"/logo.png",badge:"/logo.png",tag:o?`ci360-notif-${o}`:"ci360-alert",renotify:!1,vibrate:[150,80,150],data:{url:a||window.location.href,type:e||"general"}};try{if(U&&U.showNotification){await U.showNotification(t,s);return}const m=await((l=navigator.serviceWorker)==null?void 0:l.ready);if(m&&m.showNotification){await m.showNotification(t,s);return}}catch(m){console.warn("Service Worker notification dispatch:",m)}try{const m=new Notification(t,s);m.onclick=()=>{window.focus(),m.close()}}catch(m){console.warn("Window Notification fallback notice:",m)}}function yt(){return`
    ...
    <div class="app-shell">
      ...
      <main class="app-main" role="main">
        ...
        <nav class="mobile-bottom-nav" id="mobileBottomNav" aria-label="Mobile Navigation">
          ${k.map(f=>`
            <button type="button" class="mbn-item ${f.active?"active":""}" data-tab="${f.key}" ${f.isMore?'id="mobileMoreBtn"':""}>
              ...
              <span class="mbn-label">${p(f.label)}</span>
            ...
            <div class="mms-grid">
              ${n.map(f=>`
                <button type="button" class="mms-card ${e===f.key?"active":""}" data-tab="${f.key}">
                  ...
                  <span class="mms-card-label">${p(f.label)}</span>
                </button>
              `).join("")}
            </div>
        ...
        `)});const w=document.getElementById("logoutBtnMobile");w&&(w.onclick=R);const B=document.getElementById("topbarUserBtn"),L=document.getElementById("topbarUserDropdown");B&&L&&(B.onclick=d=>{d.stopPropagation();const g=L.style.display!=="none";L.style.display=g?"none":"block",B.setAttribute("aria-expanded",String(!g)),typeof window.ci360CloseNotifications=="function"&&window.ci360CloseNotifications()},document.addEventListener("click",d=>{!L.contains(d.target)&&!B.contains(d.target)&&(L.style.display="none",B.setAttribute("aria-expanded","false"))}));const j=document.getElementById("tudThemeToggleBtn");j&&(j.onclick=()=>{P($()==="dark"?"light":"dark")});const c=document.getElementById("topbarQuickLogJobBtn");c&&(c.onclick=()=>{t&&t("logjob")});const u=document.getElementById("logoutBtn");u&&(u.onclick=R),kt(),document.querySelectorAll(".sidebar-item").forEach(d=>{d.onclick=()=>{o(),t&&t(d.dataset.tab)}}),_t(t)}function _t(t){const i=document.getElementById("cmdPaletteBackdrop"),e=document.getElementById("cmdSearchInput"),n=document.getElementById("cmdResultsList"),a=document.getElementById("topbarCmdTrigger"),o=document.getElementById("topbarCmdTriggerMobile"),s=document.getElementById("tudCmdBtn"),l=document.getElementById("cmdCloseKbd");if(!i||!e||!n)return;const m=Array.from(document.querySelectorAll(".sidebar-item")),v=m.map(r=>{var w,B;return{type:"tab",id:r.dataset.tab,label:((w=r.querySelector("span:last-child"))==null?void 0:w.textContent)||r.dataset.tab,icon:((B=r.querySelector(".icon"))==null?void 0:B.textContent)||"📌",sub:"Navigate to section",action:()=>{t&&t(r.dataset.tab)}}});m.some(r=>r.dataset.tab==="logjob")&&v.unshift({type:"action",id:"quick-logjob",label:"Log a New Job",icon:"➕",sub:"Create & submit work delivery",action:()=>{t&&t("logjob")}}),v.push({type:"action",id:"toggle-theme",label:$()==="dark"?"Switch to Light Mode":"Switch to Dark Mode",icon:"🌓",sub:"Change interface appearance",action:()=>{P($()==="dark"?"light":"dark")}}),v.push({type:"action",id:"notifs",label:"View Notifications",icon:"🔔",sub:"Pending alerts and notices",action:()=>{const r=document.getElementById("notifBellBtn");r&&r.click()}}),v.push({type:"action",id:"logout",label:"Sign out of CI360",icon:"🚪",sub:"End current authenticated session",action:()=>R()});let h=0,b=[...v];function k(){if(!b.length){n.innerHTML='<div class="cmd-result" style="color:var(--text-4);cursor:default;justify-content:center;padding:24px 14px;">No matching tabs or commands found</div>';return}n.innerHTML=b.map((r,w)=>`
    ...
    <div class="empty">
      ...
      <p>${p(i)}</p>
      ${n}
    </div>`}function At(t,i,e="",n="📊",a=""){let o="";return a&&(o=`<span class="kpi-trend ${a.startsWith("+")||a.includes("↑")||a.toLowerCase().includes("up")?"up":"down"}">${p(a)}</span>`),`
    <div class="card kpi">
  ...
  `,s.onclick=l=>{(l.target===s||l.target.closest(".preview-modal-close"))&&s.remove()},document.body.appendChild(s)}function Y(t=[],i={}){if(!t||!t.length)return"";const e=!!i.canDelete;return`
    <div class="attachment-chips-wrap">
      ...
      <div class="attachment-chips-list">
        ${t.map((n,a)=>{const o=H(n.name,n.type),s=p(n.name||"File"),l=K(n.size);return`
  ...
  `}function at(t,i={}){const e=document.getElementById("zone-"+t),n=document.getElementById("input-"+t),a=document.getElementById("list-"+t),o=document.getElementById("count-"+t);C[t]=i.existing?[...i.existing]:[];function s(){const l=C[t]||[];if(o&&(o.textContent=`${l.length} file${l.length===1?"":"s"} attached`),!!a){if(!l.length){a.innerHTML="";return}a.innerHTML=l.map((m,v)=>{const x=H(m.name,m.type),h=p(m.name||"File"),b=K(m.size);return`
    ...
    <div class="ticket-card status-${e}" id="tkcard-${t._id}">
      <div class="ticket-card-header">
        ...
        <div class="ticket-meta-badges">
          ...
          <span class="badge ${Ht[t.priority]||"gray"}">${p(t.priority)}</span>
        </div>
      </div>
      ...
      <div class="ticket-author-row">
        ...
        <div class="ticket-author-meta">
          ...
          <span class="ticket-time-ago">${pt(t.createdAt)} · ${W(t.createdAt)}</span>
        </div>
      </div>
    ...
    </div>`}async function D(t,i,e){const n=document.getElementById("tklist-"+i),a=document.getElementById("tkcnt-"+i);if(n)try{const o=await et("/tickets/job/"+t);a&&(a.textContent=o.length),o.length?(n.innerHTML=o.map(s=>Ot(s,e)).join(""),Ft(t,i,e,n,o)):n.innerHTML='<div style="font-size:12px;color:var(--text-4);padding:8px 0;font-style:italic">No tickets on this job yet.</div>'}catch{n.innerHTML='<div style="font-size:12px;color:var(--s-red-text)">Could not load tickets.</div>'}}function Ft(t,i,e,n,a){e&&(n.querySelectorAll(".tk-status-sel").forEach(o=>{o.onchange=async()=>{try{await O("/tickets/"+o.dataset.tkid,{status:o.value}),y("Status updated"),D(t,i,e)}catch(s){y(s.message,!0)}}}),n.querySelectorAll(".tk-quick-resolve-btn").forEach(o=>{o.onclick=async()=>{try{await O("/tickets/"+o.dataset.tkid,{status:"Resolved"}),y("Ticket marked as Resolved! 🎉"),D(t,i,e)}catch(s){y(s.message,!0)}}}),n.querySelectorAll(".ticket-template-btn").forEach(o=>{o.onclick=()=>{const s=document.getElementById("tkreplytxt-"+o.dataset.tkid);s&&(s.value=o.dataset.tpl,s.focus())}}),n.querySelectorAll(".tk-reply-toggle").forEach(o=>{o.onclick=()=>{const s=o.dataset.tkid,l=document.getElementById("tkreplyform-"+s);if(l){l.classList.toggle("show");const m=a.find(v=>v._id===s);at("tkreplyup-"+s,{existing:m?m.adminAttachments:[]})}}}),n.querySelectorAll(".tk-reply-cancel").forEach(o=>{o.onclick=()=>{const s=document.getElementById("tkreplyform-"+o.dataset.tkid);s&&s.classList.remove("show")}}),n.querySelectorAll(".tk-reply-save").forEach(o=>{o.onclick=async()=>{const s=o.dataset.tkid,l=document.getElementById("tkreplytxt-"+s);if(!l)return;const m=lt("tkreplyup-"+s);try{await O("/tickets/"+s,{adminReply:l.value.trim(),adminAttachments:m}),y("Response saved! 🛡️"),D(t,i,e)}catch(v){y(v.message,!0)}}}),n.querySelectorAll(".tk-del-btn").forEach(o=>{o.onclick=async()=>{if(confirm("Permanently delete this ticket?"))try{await it("/tickets/"+o.dataset.tkid),y("Ticket deleted"),D(t,i,e)}catch(s){y(s.message,!0)}}}))}function Vt(t,i=!1){const e=t.replace(/[^a-z0-9]/gi,"");D(t,e,i),at("tkup-"+e);const n=document.querySelector(`[data-jobid="${t}"].ticket-toggle-btn`);n&&(n.onclick=()=>{const s=document.getElementById("tkform-"+e);if(!s)return;const l=s.style.display==="block";s.style.display=l?"none":"block",n.textContent=l?"+ Raise Ticket":"✕ Cancel"});const a=document.querySelector(`.tk-cancel-btn[data-safeid="${e}"]`);a&&(a.onclick=()=>{const s=document.getElementById("tkform-"+e);s&&(s.style.display="none"),n&&(n.textContent="+ Raise Ticket")});const o=document.querySelector(`.tk-submit-btn[data-safeid="${e}"]`);o&&(o.onclick=async()=>{var x,h;const s=(x=(document.getElementById("tksub-"+e)||{}).value)==null?void 0:x.trim(),l=(h=(document.getElementById("tkmsg-"+e)||{}).value)==null?void 0:h.trim(),m=(document.getElementById("tkpri-"+e)||{}).value,v=lt("tkup-"+e);if(!s){y("Please enter a subject",!0);return}if(!l){y("Please enter a message",!0);return}o.disabled=!0,o.textContent="Submitting…";try{await J("/tickets",{jobId:t,subject:s,message:l,priority:m,attachments:v}),y("Ticket submitted! 🎫");const b=document.getElementById("tkform-"+e);b&&(b.style.display="none"),n&&(n.textContent="+ Raise Ticket");const k=document.getElementById("tksub-"+e),f=document.getElementById("tkmsg-"+e);k&&(k.value=""),f&&(f.value=""),wt("tkup-"+e,[]),D(t,e,i)}catch(b){y(b.message,!0)}finally{o.disabled=!1,o.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M22 2L11 13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> Submit Ticket'}})}function Jt(){return""}function Wt(){}window.__setTheme=function(t){P(t)};Object.assign(window,{getToken:X,getUser:F,setSession:Bt,clearSession:tt,requireAuth:$t,initTheme:mt,api:T,apiGet:et,apiPost:J,apiPut:O,apiPatch:St,apiDelete:it,fmtINR:It,fmtHours:Ct,escapeHtml:p,fmtDate:W,flashToast:y,openModal:ft,logout:R,getTheme:$,setTheme:P,initServiceWorker:nt,playNotificationChime:vt,triggerPhoneVibration:ht,requestNotificationPermission:Q,triggerSystemNotification:q,fmtFileSize:K,getFileCategory:H,isImageAttachment:Rt,openFilePreviewModal:ot,renderAttachmentChips:Y,uploadFilesToServer:Z,renderAttachmentUploader:st,bindAttachmentUploader:at,getUploaderAttachments:lt,setUploaderAttachments:wt,renderRoleSwitcher:Jt,bindRoleSwitcher:Wt,renderNotificationBell:yt,initNotificationBell:kt,renderAppShell:Et,bindAppShellEvents:Tt,renderSkeletonCards:Lt,renderEmptyState:Nt,renderKpiCard:At,renderBadge:Dt,renderProgressBar:Pt,renderPeriodPicker:jt,renderSupportTicketSection:Ut,bindSupportTicketSection:Vt});export{X as a,J as b,F as g,Bt as s};
